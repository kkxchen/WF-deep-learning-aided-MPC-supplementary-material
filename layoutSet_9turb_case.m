function [Wp] = layoutSet_9turb_case()
...
Wp.site = struct(...
    'u_Inf',10,... % Initial long. wind speed in m/s 12.0214
    'v_Inf',0,... % Initial lat. wind speed in m/s
...
Wp.mesh = struct(...
    'Lx',2520,... % Domain length in x-direction
    'Ly',1560,... % Domain length in y-direction
    'Nx',100,... % Number of cells in x-direction
    'Ny',55 ... % Number of cells in y-direction
    );
